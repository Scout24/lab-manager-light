...
window.lml.ConfigurationController = function ConfigurationController($scope, $log, AjaxCallService) {
  ...
  AjaxCallService.sendAjaxCall('/lml/web/api/configuration.pl',{}, function successCallback(data){
    //$log.info("Received configuration data: ",data);
    $scope.data = data;
  });

  AjaxCallService.sendAjaxCall('/lml/web/api/configuration_files.pl',{}, function successCallback(data){
