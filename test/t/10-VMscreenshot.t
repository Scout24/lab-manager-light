...
dies_ok { new LML::VMscreenshot( new LML::Config ) } "Should die with parameter error";
is( new LML::VMscreenshot( new LML::Config, "abcd" ), undef, "New object with invalid uuid should be undef" );
